var productos = [
  ...
  {
    nombre: 'Blue-Ray',
    descripcion: 'Peliculas Y Series en DVD',
    foto: 'http://cazandochollos.es/wp-content/uploads/sites/10/2015/05/peli%CC%81culas-baratas-en-bluray.png',
    precio: 10,
    vegano: false
  },
  {
    nombre: 'Tazas',
    descripcion: 'Merchandising de todo tipo de tazas',
    foto: 'http://www.sd-toys.com/fotos/producte/zoom/358.jpg',
    precio: 12,
    vegano: false
  }
];
